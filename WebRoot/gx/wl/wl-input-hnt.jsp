            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <input type="text" name="materialName"  value="混凝土" data-rule="required" size="20" readonly>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        ...
                        <input type="text" name="enterTime" value="${model.enterTime }" size="20" data-toggle="datepicker" data-pattern="yyyy-MM-dd HH:mm:ss" readonly="readonly"  data-rule="required">
                    </td>
                </tr>
                <tr>
                	<td>
                ...
                <tr>
                    <td>
                        ...
                        <input type="text" name="measurementUnit"  value="m3" size="20" readonly>
                    </td>
                </tr>
                <tr>
                	<td>
