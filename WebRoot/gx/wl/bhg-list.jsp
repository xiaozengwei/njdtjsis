...
<div class="bjui-pageHeader">
	<form id="pagerForm" data-toggle="ajaxsearch" action="<%=basePath%>wl/bhg-list.do" method="post">
		...
		<div class="bjui-searchBar" style="line-height:40px">
			...
			&nbsp;
			<button type="button" class="btn-green" data-url="<%=basePath%>wl/bhg-input.do" data-toggle="dialog" data-target="sb-input" data-id="sb-input-dialog" data-icon="plus" data-width="500" data-height="500">添加</button>
			&nbsp;
			<button type="button" class="btn-blue" data-url="<%=basePath%>wl/bhg-remove.do" data-toggle="doajaxchecked" data-confirm-msg="确定要删除选中项吗？" data-icon="remove" data-idname="delids" data-group="ids">删除选中行</button>
		</div>
	</form>
</div>
	...
	<table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
		<thead>
			<tr>
				...
				<th width="10%" align="center" >检测项目</th>
				<th width="10%" align="center" >检测报告编号</th>
				<th width="10%" align="center">检测结果</th>
				<th width="10%" align="center">初检/复检</th>
				<th width="10%" align="center">处理意见</th>
		...
		<tbody>
			<c:forEach items="${page.result}" var="bhg" varStatus="status">
				<tr data-id="${bhg.rowId}">
					...
					<td align="center">
						<a class="btn btn-blue" href="<%=basePath%>wl/bhg-input.do?rowId=${bhg.rowId}" data-toggle="dialog" data-id="sb-update" data-width="500" data-height="500" data-title="编辑">编辑</a>
						<a class="btn btn-default" href="<%=basePath%>wl/bhg-detail.do?rowId=${bhg.rowId}" data-toggle="dialog" data-id="sb-detail" data-width="500" data-height="500" data-title="查看详情">查看详情</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
