<%@ page language="java" pageEncoding="UTF-8"
	import="java.util.*,com.gx.soft.hr.persistence.domain.GxHrOrg"%>
...
<div class="bjui-pageContent">
	<div style="float:left;">
		...
		<div
			...
			<ul id="article-manager-column-tree" class="ztree" data-toggle="ztree" data-options="{nodes:'returnTreeJSON',
	...
	<div style="margin-left:255px; height:100%;border:1px #c3ced5 solid;"  id="column-article-list"></div>
...
function showUsers(event, treeId, treeNode){
	...
	$.CurrentNavtab.bjuiajax('doLoad', {url:'<%=basePath%>portal/manager/column/article/list.do', target:'#column-article-list',data:'columnId='+treeNode.id});
	event.preventDefault();
}
function returnTreeJSON() {
	var jsont ;
	$.ajax({
		url:'<%=basePath%>portal/column/tree.do',
		type:'get',
		async:false,
		cache:false,
		dataType:'json',
