...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=basePath%>view/view-list.do" method="post">
...
<div class="bjui-pageContent">
    <table  class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        <tr>
            ...
            <th width="15%" align="center">物理地址</th>
            <th width="15%" align="center" >hls-url-地址</th>
        ...
        <c:forEach items="${page.result}" var="view" varStatus="status">
            <tr data-id="${view.rowId}">
                ...
                <td align="center">${view.wlAddress}</td>
                <td align="center">${view.hlsLcAddress}</td>
                <td align="center">
                    <button class="btn btn-blue" onclick="show('${view.hlsLcAddress}')">播放</button>
                    <a class="btn btn-blue" href="<%=basePath%>view/view-input.do?rowId=${view.rowId}" data-toggle="dialog" data-id="view-update" data-width="500" data-height="500" data-title="编辑">编辑</a>
                </td>
            </tr>
        </c:forEach>
    </table>
