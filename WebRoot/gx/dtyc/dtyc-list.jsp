...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=basePath%>dtyc/weeklyreport-list.do" method="post">
...
<div class="bjui-pageContent">
    <table  class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        <tr>
            ...
            <th width="7%" align="center">上传人姓名</th>
        ...
        <c:forEach items="${page.result}" var="view" varStatus="status">
            <tr data-id="${view.rowId}">
                ...
                <td align="center">${view.applicantName }</td>
                <td align="center">${view.applicantIdCard }</td>
                <td align="center">${view.applicantPhone }</td>
                <td align="center">${view.bdId }</td>
                <td align="center">${view.ycMs }</td>
                <td align="center">${view.ycAddress }</td>
                <td align="center">${view.clYj }</td>
                <td align="center">
                    <button class="btn-blue" data-url="<%=basePath%>dtyc/dtyc-edit.do?rowId=${view.rowId}" data-toggle="dialog" data-id="generalize-update11" data-mask="true" data-width="500" data-height="900"  data-title="编辑">编辑</button>
                </td>
            </tr>
        </c:forEach>
    </table>
