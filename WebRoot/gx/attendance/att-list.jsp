...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=basePath%>attendance/att-list.do" method="post" style="margin-bottom: 0">
        ...
        <div class="bjui-searchBar">
            ...
            <label>姓名：</label>
            <input tepe="test" id="userName" name="filter_LIKES_userName" value="${param.filter_LIKES_userName}" class="form-control" siz="15"><br/>
            <label>开始日期：</label>
            ...
            <div class="pull-right">
                <label>开始日期：</label>
                <input type="text" name="start" data-toggle="datepicker" data-rule="date" size="10">&nbsp;&nbsp;
                <label>结束日期：</label>
                <input type="text" name="end" id="j_custom_issuedate" data-toggle="datepicker" data-rule="date" size="10">
                <label>类型：</label>
