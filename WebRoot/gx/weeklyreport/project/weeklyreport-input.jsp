...
<script>
    ...
    $(function () {
        var uploader = new plupload.Uploader({
            ...
            //服务器端的上传页面地址
            url : '<%=basePath%>weeklyreportproject/fileupload.do',
...
<div class="bjui-pageContent">
    <form action="<%=basePath%>weeklyreportproject/weeklyreport-save.do" method="post" data-toggle="validate" data-reloadNavtab="true" onsubmit="return check(this)">
        <input type="hidden" name="rowId"  value="${weeklyReportProject.rowId}" >
        <table class="table table-condensed table-hover">
            <tbody>
            <tr>
                <td>
                    <label class="control-label x90" style="width: 105px;">时间周期：</label>
                    <input type="number" name="ext1"  value="${weeklyReportProject.ext1}" data-rule="required">
                </td>
            </tr>
            <tr>
                <td>
                    <label class="control-label x90" style="width: 105px;">开始时间：</label>
                    <input id="startTime" type="text" name="ext2"  value="${weeklyReportProject.ext2}" data-toggle="datepicker" data-pattern="yyyy-MM-dd HH:mm:ss" readonly="readonly"  data-rule="required">
                </td>
            </tr>
            <tr>
                <td>
                    <label class="control-label x90" style="width: 105px;">结束时间：</label>
                    <input id="endTime" type="text" name="ext3"  value="${weeklyReportProject.ext3}" data-toggle="datepicker" data-pattern="yyyy-MM-dd HH:mm:ss" readonly="readonly" data-rule="required">
                </td>
            </tr>
            <tr>
                <td>
                    <label class="control-label x90" style="width: 105px;">周报：</label>
                    <script id="container" name="thisWeekWork" type="text/plain">${weeklyReportProject.thisWeekWork }</script>
                    <input id="ext4" type="hidden" name="ext4">
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <textarea name="otherWork"  data-toggle="autoheight">
                        ${weeklyReportProject.otherWork}
                    </textarea>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="hidden" name="bdId"  value="${weeklyReportProject.bdId}" >
                    <label class="control-label x90" style="width: 105px;">标段：</label>
                    <input type="text" name="bdName"  data-rule="required" readonly="readonly" value="${weeklyReportProject.bdName}" data-toggle="lookup" data-url="<%=basePath %>risk/lookup-risk-bdId-list.do"  data-title="请选择标段名称:" >
                </td>
            </tr>
            <tr>
                <td id="columnArticleTitlePicForm">
                    <table width="90%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn-red" data-url="<%=basePath%>weeklyreportproject/delete.do" data-toggle="doajaxchecked" data-confirm-msg="确定要删除选中项吗？" data-icon="remove" data-idname="delids" data-group="ids" data-callback="callback">删除选中文件</button>
                            </td>
                            <td>
...
<div class="bjui-pageFooter">
    <ul>
        ...
        <li><button type="submit" id="submit" class="btn-default" onclick="check1()">保存</button></li>
    </ul>
</div>
