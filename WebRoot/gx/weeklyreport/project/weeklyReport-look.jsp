        ...
        <table class="table table-condensed table-hover">
            ...
            <tr>
                <td>
                    ...
                    <script id="container" name="thisWeekWork" type="text/plain">
                        ${weeklyReportProject.thisWeekWork }
                    </script>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="bdName"  readonly="readonly" value="${weeklyReportProject.bdName}" data-toggle="lookup" data-url="<%=basePath %>risk/lookup-risk-bdId-list.do"  data-title="请选择标段名称:" >
                </td>
            </tr>
            <tr>
