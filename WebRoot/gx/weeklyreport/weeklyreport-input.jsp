...
<div class="bjui-pageContent">
    <form action="<%=basePath%>weeklyreport/weeklyreport-save.do" method="post" data-toggle="validate" data-reloadNavtab="true" onsubmit="return check(this)">
        ...
        <table class="table table-condensed table-hover">
            ...
            <tr>
                <td>
                    ...
                    <script id="container" name="thisWeekWork" type="text/plain">${weeklyReport.thisWeekWork}</script>
