...
/**
 * UnqualifiedTestJczx entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "unqualified_test_jczx", catalog = "njdtjsis")
public class UnqualifiedTestJczx implements java.io.Serializable {
	...
	/** default constructor */
	public UnqualifiedTestJczx() {
	}

	/** full constructor */
	public UnqualifiedTestJczx(String materialName, Date entrustDate,
