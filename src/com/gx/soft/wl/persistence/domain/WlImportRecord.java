...
/**
 * WlImportRecord entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "wl_import_record", catalog = "njdtjsis")
public class WlImportRecord implements java.io.Serializable {
	...
	/** default constructor */
	public WlImportRecord() {
	}

	/** full constructor */
	public WlImportRecord(String fileName, String fileType,
