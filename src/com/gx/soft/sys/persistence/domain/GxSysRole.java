...
/**
 * GxSysRole entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "gx_sys_role")
public class GxSysRole implements java.io.Serializable {
	...
	/** minimal constructor */
	public GxSysRole(String rowId) {
		this.rowId = rowId;
	}

	/** full constructor */
	public GxSysRole(String rowId, String roleName, String roleId,
			String roleIntro, Timestamp createTime, String createUserId,
			Timestamp modifyTime, String modifyUserId, String dataStatus,
			Long dataOrder, String parentRoleId, String parentRoleName,
			String roleType) {
		this.rowId = rowId;
