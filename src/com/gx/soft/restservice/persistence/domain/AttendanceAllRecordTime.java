...
@Entity
@Table(name = "attendance_all_record_time", schema = "njdtjsis", catalog = "")
public class AttendanceAllRecordTime {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        AttendanceAllRecordTime that = (AttendanceAllRecordTime) o;
