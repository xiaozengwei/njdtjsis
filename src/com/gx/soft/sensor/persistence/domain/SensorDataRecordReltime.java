...
/**
 * SensorDataRecordReltime entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "sensor_data_record_reltime", catalog = "njdtjsis")
public class SensorDataRecordReltime implements java.io.Serializable {
	...
	/** default constructor */
	public SensorDataRecordReltime() {
	}

	/** full constructor */
	public SensorDataRecordReltime(String sensorSiteName, String sensorSiteJd,
